...
defineLocale('kk', {
  ...
  'shareGuide.title': 'دوس جۇرىنعا ٴبولىسۋ', // 分享到朋友圈
  'shareGuide.desc': 'بۇل ۇلگىنى ەكىنشى رەت قولدانىپ وتىرسىز. دوس جۇرىنعا ٴبولىسسەڭىز 1 رەت تەگىن جاساۋ مۇمكىندىگىن الا الاسىز!', // 这是您第 2 次使用本模板，分享到朋友圈即可免费获得 1 次制作机会！
  'shareGuide.step1': '① تومەندەگى «دوس جۇرىنعا ٴبولىسۋ» تۇيمەسىن باسىپ، شاقىرىۋىڭىزدى دوس جۇرىنىڭىزعا ٴبولىسىڭىز', // ① 点击下方「分享到朋友圈」，将请柬分享到您的朋友圈
  'shareGuide.step2': '② ٴبولىسكەننەن كەيىن «مەن ٴبولىستىم، جاساۋدى جالعاستىرامىن» تۇيمەسىن باسىڭىز', // ② 分享完成后，点击「我已分享，继续制作」
  'shareGuide.btn_share': 'دوس جۇرىنعا ٴبولىسۋ', // 分享到朋友圈
  'shareGuide.btn_done': 'مەن ٴبولىستىم، جاساۋدى جالعاستىرامىن', // 我已分享，继续制作
  'shareGuide.btn_pay': 'تولەپ جاساۋ ¥6.6', // 直接付费制作 ¥6.6
  'shareGuide.btn_vip': 'VIP اشىپ تەگىن جاساۋ', // 开通VIP免费制作
  'shareGuide.sharing': 'ٴبولىسۋدە...', // 分享中...
  'shareGuide.reward_ok': 'ٴبولىسۋ ٴساتتى بولدى! 1 رەت تەگىن جاساۋ مۇمكىندىگىن الدىڭىز', // 分享成功，已获得 1 次免费制作机会
  'shareGuide.reward_fail': 'بۇگىن ٴبولىسكەنسىز. تولەپ جاساڭىز نەمەسە VIP اشىڭىز', // 今日已分享过，请直接付费或开通VIP
  'shareGuide.need_moments': 'الدىمەن دوس جۇرىنعا ٴبولىسىپ، سوسىن «مەن ٴبولىستىم» تۇيمەسىن باسىڭىز', // 请先分享到朋友圈，再点击「我已分享」
})
