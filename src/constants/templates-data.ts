...
const WEDDING_1_DATA: TemplateData = {
  ...
  photo4: '/static/images/templates/wedding-5.png',
  photoTitle: '婚礼邀请函',
...
const WEDDING_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/wedding-2.png',
  coverTitle: '适我愿兮',
  coverSubtitle: 'Love Forever',
  photo1: '/static/images/templates/wedding-3.png',
  photo2: '/static/images/templates/wedding-4.png',
  photo3: '/static/images/templates/wedding-5.png',
  photo4: '/static/images/templates/wedding-6.png',
  photoTitle: '我们的故事',
...
const WEDDING_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/wedding-2.png', dataKey: 'coverImage', label: '封面图片' },
  { type: 'text', text: '2050.05.20', label: '婚礼日期', style: { ...DEFAULT_ELEMENT_STYLE, fontSize: 36, color: '#ffffff' } },
  ...
  { type: 'image', text: '/static/images/templates/wedding-3.png', dataKey: 'photo1', label: '相册图片1' },
...
const WEDDING_3_DATA: TemplateData = {
  coverImage: '/static/images/templates/wedding-3.png',
  coverTitle: '佳偶天成',
  coverSubtitle: 'A PERFECT MATCH',
  photo1: '/static/images/templates/wedding-4.png',
  photo2: '/static/images/templates/wedding-5.png',
  photo3: '/static/images/templates/wedding-6.png',
...
const WEDDING_3_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/wedding-3.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/wedding-4.png', dataKey: 'photo1', label: '相册图片' },
...
const BIRTHDAY_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/invitation-1.png',
  coverTitle: '节日快乐',
  coverSubtitle: 'HAPPY HOLIDAY',
  photo1: '/static/images/templates/invitation-2.png',
  photo2: '/static/images/templates/invitation-3.png',
  photo3: '/static/images/templates/invitation-4.png',
  photo4: '/static/images/templates/invitation-1.png',
  photoTitle: '节日派对',
...
const BIRTHDAY_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/invitation-1.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/invitation-2.png', dataKey: 'photo1', label: '派对图片' },
...
const BIRTHDAY_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/invitation-2.png',
  coverTitle: '甜蜜派对',
  coverSubtitle: 'SWEET PARTY',
  photo1: '/static/images/templates/invitation-3.png',
  photo2: '/static/images/templates/invitation-4.png',
  photo3: '/static/images/templates/invitation-1.png',
  photo4: '/static/images/templates/invitation-2.png',
  photoTitle: '美好时光',
...
const BIRTHDAY_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/invitation-2.png', dataKey: 'coverImage', label: '封面图片' },
  { type: 'text', text: '2050.06.15', label: '节日日期', style: { ...DEFAULT_ELEMENT_STYLE, fontSize: 36, color: '#ffffff' } },
  ...
  { type: 'image', text: '/static/images/templates/invitation-3.png', dataKey: 'photo1', label: '派对图片' },
...
const BABY_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/template-1.png',
  coverTitle: '满月宴',
  coverSubtitle: 'BABY SHOWER',
  photo1: '/static/images/templates/template-2.png',
  photo2: '/static/images/templates/template-3.png',
  photo3: '/static/images/templates/template-4.png',
  photo4: '/static/images/templates/template-5.png',
  photoTitle: '宝宝的到来',
...
const BABY_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/template-1.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/template-2.png', dataKey: 'photo1', label: '宝宝图片' },
...
const BABY_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/template-5.png',
  coverTitle: '百日宴',
  coverSubtitle: '100 DAYS CELEBRATION',
  photo1: '/static/images/templates/template-1.png',
  photo2: '/static/images/templates/template-2.png',
  photo3: '/static/images/templates/template-3.png',
  photo4: '/static/images/templates/template-4.png',
  photoTitle: '幸福时刻',
...
const BABY_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/template-5.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/template-1.png', dataKey: 'photo1', label: '宝宝图片' },
...
const GRADUATION_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/moments-1.png',
  coverTitle: '升学宴',
  coverSubtitle: 'GRADUATION',
  photo1: '/static/images/templates/moments-2.png',
  photo2: '/static/images/templates/template-1.png',
  photo3: '/static/images/templates/template-2.png',
  photo4: '/static/images/templates/moments-1.png',
  photoTitle: '青春不散场',
...
const GRADUATION_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/moments-1.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/moments-2.png', dataKey: 'photo1', label: '毕业图片' },
...
const GRADUATION_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/moments-2.png',
  coverTitle: '青春纪念册',
  coverSubtitle: 'MEMORIES OF YOUTH',
  photo1: '/static/images/templates/moments-1.png',
  photo2: '/static/images/templates/template-3.png',
  photo3: '/static/images/templates/template-4.png',
  photo4: '/static/images/templates/moments-2.png',
  photoTitle: '同学情',
...
const GRADUATION_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/moments-2.png', dataKey: 'coverImage', label: '封面图片' },
  { type: 'text', text: '2050.07.01', label: '毕业日期', style: { ...DEFAULT_ELEMENT_STYLE, fontSize: 36, color: '#ffffff' } },
  ...
  { type: 'image', text: '/static/images/templates/moments-1.png', dataKey: 'photo1', label: '毕业图片' },
...
const FESTIVAL_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/invitation-3.png',
  coverTitle: '新年快乐',
  coverSubtitle: 'HAPPY NEW YEAR',
  photo1: '/static/images/templates/invitation-4.png',
  photo2: '/static/images/templates/wedding-3.png',
  photo3: '/static/images/templates/invitation-1.png',
  photo4: '/static/images/templates/invitation-2.png',
  photoTitle: '恭贺新禧',
...
const FESTIVAL_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/invitation-3.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/invitation-4.png', dataKey: 'photo1', label: '节日图片' },
...
const FESTIVAL_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/invitation-4.png',
  coverTitle: '中秋团圆',
  coverSubtitle: 'MID-AUTUMN FESTIVAL',
  photo1: '/static/images/templates/invitation-1.png',
  photo2: '/static/images/templates/invitation-2.png',
  photo3: '/static/images/templates/invitation-3.png',
  photo4: '/static/images/templates/invitation-4.png',
  photoTitle: '花好月圆',
...
const FESTIVAL_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/invitation-4.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/invitation-1.png', dataKey: 'photo1', label: '中秋图片' },
...
const BUSINESS_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/template-3.png',
  coverTitle: '公司年会',
  coverSubtitle: 'ANNUAL MEETING',
  photo1: '/static/images/templates/template-4.png',
  photo2: '/static/images/templates/wedding-4.png',
  photo3: '/static/images/templates/template-3.png',
  photo4: '/static/images/templates/template-3.png',
  photoTitle: '携手同行',
...
const BUSINESS_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/template-3.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/template-4.png', dataKey: 'photo1', label: '公司图片' },
...
const BUSINESS_2_DATA: TemplateData = {
  coverImage: '/static/images/templates/template-4.png',
  coverTitle: '新品发布',
  coverSubtitle: 'NEW PRODUCT LAUNCH',
  photo1: '/static/images/templates/template-3.png',
  photo2: '/static/images/templates/template-5.png',
  photo3: '/static/images/templates/template-4.png',
  photo4: '/static/images/templates/template-4.png',
  photoTitle: '创新未来',
...
const BUSINESS_2_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/template-4.png', dataKey: 'coverImage', label: '封面图片' },
  ...
  { type: 'image', text: '/static/images/templates/template-3.png', dataKey: 'photo1', label: '产品图片' },
...
const PROPOSAL_1_ELEMENTS: EditableElement[] = [
  ...
  { type: 'image', text: '/static/images/templates/wedding-2.png', dataKey: 'photo1', label: '相册图片' },
...
const CONSULTATION_TEA_1_DATA: TemplateData = {
  coverImage: '/static/images/templates/template-2.png',
  coverTitle: '喜结良缘',
  coverSubtitle: 'A PERFECT MATCH',
  photo1: '/static/images/templates/wedding-4.png',
  photo2: '/static/images/templates/wedding-5.png',
...
const CONSULTATION_TEA_1_ELEMENTS: EditableElement[] = [
  { type: 'image', text: '/static/images/templates/template-2.png', dataKey: 'coverImage', label: '封面图片' },
...
const HOUSEWARMING_1_DATA: TemplateData = {
  ...
  photo1: '/static/images/templates/template-4.png',
  photo2: '/static/images/templates/template-5.png',
  photo3: '/static/images/templates/wedding-1.png',
  photo4: '/static/images/templates/wedding-2.png',
  photoTitle: '新居落成',
...
const HOUSEWARMING_1_ELEMENTS: EditableElement[] = [
  ...
  { type: 'image', text: '/static/images/templates/template-4.png', dataKey: 'photo1', label: '新居图片' },
...
export const TEMPLATE_LIST: TemplateItem[] = [
  {
    ...
    subtitle: '双向奔赴的爱情',
    category: 'wedding',
    cover: '/static/images/templates/wedding-1.png',
    likes: 639400,
    pageCount: 15,
    data: WEDDING_1_DATA,
  ...
  },
  {
    ...
    subtitle: '永恒的誓言',
    category: 'wedding',
    cover: '/static/images/templates/wedding-2.png',
    likes: 452100,
    pageCount: 12,
    data: WEDDING_2_DATA,
  ...
  },
  {
    ...
    subtitle: '简约中式婚礼',
    category: 'wedding',
    cover: '/static/images/templates/wedding-3.png',
    likes: 387600,
    pageCount: 14,
    data: WEDDING_3_DATA,
  ...
  },
  {
    ...
    cover: '/static/images/templates/invitation-1.png',
    likes: 285600,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '分享美好时光',
    category: 'festival-invitation',
    cover: '/static/images/templates/invitation-2.png',
    likes: 198700,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '小天使降临',
    category: 'baby',
    cover: '/static/images/templates/template-1.png',
    likes: 198300,
    pageCount: 10,
    data: BABY_1_DATA,
  ...
  },
  {
    ...
    subtitle: '幸福时刻记录',
    category: 'baby',
    cover: '/static/images/templates/template-5.png',
    likes: 156200,
    pageCount: 10,
    data: BABY_2_DATA,
  ...
  },
  {
    ...
    subtitle: '青春不散场',
    category: 'study',
    cover: '/static/images/templates/moments-1.png',
    likes: 156700,
    pageCount: 12,
  ...
  },
  {
    ...
    subtitle: '同学情永不忘',
    category: 'study',
    cover: '/static/images/templates/moments-2.png',
    likes: 124500,
    pageCount: 12,
  ...
  },
  {
    ...
    subtitle: '美好祝福送给您',
    category: 'birthday',
    cover: '/static/images/templates/invitation-3.png',
    likes: 378200,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '花好月圆人团圆',
    category: 'birthday',
    cover: '/static/images/templates/invitation-4.png',
    likes: 256800,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '携手共创辉煌',
    category: 'poster',
    cover: '/static/images/templates/template-3.png',
    likes: 89400,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '创新引领未来',
    category: 'poster',
    cover: '/static/images/templates/template-4.png',
    likes: 76500,
    pageCount: 10,
  ...
  },
  {
    ...
    subtitle: '以茶为媒 共话未来',
    category: 'creative',
    cover: '/static/images/templates/template-2.png',
    likes: 156300,
    pageCount: 10,
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        image: '/static/images/templates/wedding-2.png',
        dataKey: 'photo1',
        editable: true,
      },
      {
      ...
      },
      {
        ...
        label: '照片2',
        placeholder: '点击上传照片',
        image: '/static/images/templates/wedding-3.png',
        dataKey: 'photo2',
        editable: true,
      },
      {
  ...
  },
  {
    ...
    data: {
      ...
      photo2: '/static/images/templates/wedding-5.png',
      photo3: '/static/images/templates/wedding-1.png',
      photo4: '/static/images/templates/wedding-3.png',
      photoTitle: '爱的承诺',
    ...
    sections: [
      ...
      },
      {
        ...
        label: '主图',
        placeholder: '点击上传主图',
        image: '/static/images/templates/wedding-4.png',
        dataKey: 'photo1',
        editable: true,
      },
      {
      ...
      },
      {
        ...
        label: '照片2',
        placeholder: '点击上传照片',
        image: '/static/images/templates/wedding-5.png',
        dataKey: 'photo2',
        editable: true,
      },
      {
  ...
  // ============ 【模板 - 翻页模式 1】时光与你 ============
  {
    ...
    pages: [
      // P1 封面页
      {
        ...
        name: '封面',
        pageType: 'cover',
        background: { type: 'image', color1: '#ffffff', imageUrl: '/static/images/templates/wedding-1.png', imageScale: 'cover' } as TemplateBackground,
        elements: [
      ...
      // P2 照片展示（2宫格）
      {
        ...
        elements: [
          { id: 'p2-img1', type: 'image', text: '/static/images/templates/wedding-2.png', label: '照片1', dataKey: 'photo1', x: 5, y: 5, width: 42.5, height: 42, zIndex: 1, rotation: 0, opacity: 1, editable: true },
          { id: 'p2-img2', type: 'image', text: '/static/images/templates/wedding-3.png', label: '照片2', dataKey: 'photo2', x: 52.5, y: 5, width: 42.5, height: 42, zIndex: 1, rotation: 0, opacity: 1, editable: true },
          ...
          { id: 'p2-img3', type: 'image', text: '/static/images/templates/wedding-4.png', label: '照片3', dataKey: 'photo3', x: 5, y: 58, width: 90, height: 37, zIndex: 1, rotation: 0, opacity: 1, editable: true },
        ],
      },
      // P3 邀请正文
      {
        ...
        elements: [
          ...
          { id: 'p3-img1', type: 'image', text: '/static/images/templates/wedding-5.png', label: '装饰图片', x: 25, y: 75, width: 50, height: 20, zIndex: 1, rotation: 0, opacity: 1, editable: true },
        ],
      },
      // P4 时间地点
      {
        ...
        elements: [
          ...
          { id: 'p4-t4', type: 'text', text: '幸福大酒店', label: '酒店名称', dataKey: 'location', x: 15, y: 45, width: 70, height: 4, zIndex: 2, rotation: 0, opacity: 1, editable: true, style: { font: '思源宋体', color: '#333333', fontSize: 28, spacing: 2, lineHeight: 1.5, fontWeight: 'bold', textAlign: 'center' } },
          ...
          { id: 'p4-img1', type: 'image', text: '/static/images/templates/wedding-2.png', label: '装饰图', x: 10, y: 62, width: 80, height: 32, zIndex: 1, rotation: 0, opacity: 1, editable: true },
        ],
      },
      // P5 单张照片
      {
        ...
        name: '照片·时光',
        pageType: 'photo',
        background: { type: 'image', color1: '#ffffff', imageUrl: '/static/images/templates/wedding-3.png', imageScale: 'cover' } as TemplateBackground,
        elements: [
      ...
      // P7 4宫格照片
      {
        ...
        background: { type: 'solid', color1: '#faf6f3' } as TemplateBackground,
        elements: [
          { id: 'p7-img1', type: 'image', text: '/static/images/templates/wedding-1.png', label: '照片1', dataKey: 'photo1', x: 5, y: 8, width: 42.5, height: 40, zIndex: 1, rotation: 0, opacity: 1, editable: true },
          { id: 'p7-img2', type: 'image', text: '/static/images/templates/wedding-2.png', label: '照片2', dataKey: 'photo2', x: 52.5, y: 8, width: 42.5, height: 40, zIndex: 1, rotation: 0, opacity: 1, editable: true },
          { id: 'p7-img3', type: 'image', text: '/static/images/templates/wedding-4.png', label: '照片3', dataKey: 'photo3', x: 5, y: 52, width: 42.5, height: 40, zIndex: 1, rotation: 0, opacity: 1, editable: true },
          { id: 'p7-img4', type: 'image', text: '/static/images/templates/wedding-5.png', label: '照片4', dataKey: 'photo4', x: 52.5, y: 52, width: 42.5, height: 40, zIndex: 1, rotation: 0, opacity: 1, editable: true },
        ],
      },
      // P8 尾页
      {
        ...
        name: '尾页',
        pageType: 'ending',
        background: { type: 'image', color1: '#ffffff', imageUrl: '/static/images/templates/wedding-5.png', imageScale: 'cover' } as TemplateBackground,
        elements: [
