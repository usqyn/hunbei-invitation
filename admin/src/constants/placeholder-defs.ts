...
export const PLACEHOLDER_DEFS: PlaceholderDef[] = [
  ...
  { key: 'kzInviterMale', label: '男邀请者', icon: '🤵', group: 'kz', placeholder: 'باقىتپەك قۋانبەك ۇلى', preview: 'باقىتپەك قۋانبەك ۇلى' },
  { key: 'kzInviterFemale', label: '女邀请者', icon: '👰', group: 'kz', placeholder: 'جادىرا شاتتق قىزى', preview: 'جادىرا شاتتق قىزى' },
  { key: 'kzInviterFather', label: '邀请者父亲', icon: '👴', group: 'kz', placeholder: 'مۇرات', preview: 'مۇرات' },
  { key: 'kzInviterMother', label: '邀请者母亲', icon: '👵', group: 'kz', placeholder: 'گۇلنارا', preview: 'گۇلنارا' },
